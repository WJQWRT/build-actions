...
# 后台IP设置
export Ipv4_ipaddr="10.100.10.1"            # 修改openwrt后台地址(填0为关闭)
export Netmask_netm="255.0.0.0"         # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="WJQWRT"     
...
#export Replace_Kernel="6.12" # 预留6.12内核
